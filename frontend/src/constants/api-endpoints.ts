export const API_ENDPOINTS = {
  ...
  gmeet: {
    settings: '/communications/gmeet/settings/',
    classes: '/communications/gmeet/classes/',
    classDetail: (id: number) => `/communications/gmeet/classes/${id}/`,
    meetings: '/communications/gmeet/meetings/',
    meetingDetail: (id: number) => `/communications/gmeet/meetings/${id}/`,
    join: (id: number) => `/communications/gmeet/join/${id}/`,
    classReport: '/communications/gmeet/reports/class/',
    meetingReport: '/communications/gmeet/reports/meeting/',
    classViewers: (id: number) => `/communications/gmeet/reports/class/${id}/viewers/`,
    meetingViewers: (id: number) => `/communications/gmeet/reports/meeting/${id}/viewers/`,
  },
  zoom: {
    settings: '/communications/zoom/settings/',
    classes: '/communications/zoom/classes/',
    classDetail: (id: number) => `/communications/zoom/classes/${id}/`,
    meetings: '/communications/zoom/meetings/',
    meetingDetail: (id: number) => `/communications/zoom/meetings/${id}/`,
    join: (id: number) => `/communications/zoom/join/${id}/`,
    classReport: '/communications/zoom/reports/class/',
    meetingReport: '/communications/zoom/reports/meeting/',
    classViewers: (id: number) => `/communications/zoom/reports/class/${id}/viewers/`,
    meetingViewers: (id: number) => `/communications/zoom/reports/meeting/${id}/viewers/`,
  },
  health: '/health/',
} as const;
