export const API_ENDPOINTS = {
  ...
  settings: {
    ...
    notificationSettingDetail: (id: number) => `/settings/notification-settings/${id}/`,
    smsConfig: '/settings/sms-config/',
    smsConfigDetail: (id: number) => `/settings/sms-config/${id}/`,
    smsConfigActivate: (id: number) => `/settings/sms-config/${id}/activate/`,
    emailConfig: '/settings/email-config/',
    emailConfigDetail: (id: number) => `/settings/email-config/${id}/`,
    emailConfigActivate: (id: number) => `/settings/email-config/${id}/activate/`,
    paymentMethods: '/settings/payment-methods/',
    paymentMethodDetail: (id: number) => `/settings/payment-methods/${id}/`,
    paymentMethodActivate: (id: number) => `/settings/payment-methods/${id}/activate/`,
    printHeaderFooter: '/settings/print-header-footer/',
    printHeaderFooterDetail: (id: number) => `/settings/print-header-footer/${id}/`,
    ...
    moduleDetail: (id: number) => `/settings/modules/${id}/`,
    customFields: '/settings/custom-fields/',
    customFieldDetail: (id: number) => `/settings/custom-fields/${id}/`,
    captcha: '/settings/captcha/',
    captchaDetail: (id: number) => `/settings/captcha/${id}/`,
    systemFields: '/settings/system-fields/',
    onlineAdmissionSettings: '/settings/online-admission/',
    onlineAdmissionFields: '/settings/online-admission/fields/',
    onlineAdmissionFieldDetail: (id: number) => `/settings/online-admission/fields/${id}/`,
    sidebarMenus: '/settings/sidebar-menus/',
    sidebarMenuDetail: (id: number) => `/settings/sidebar-menus/${id}/`,
    sidebarSubmenus: '/settings/sidebar-submenus/',
    sidebarSubmenuDetail: (id: number) => `/settings/sidebar-submenus/${id}/`,
  ...
  students: {
    ...
    disable: (id: number) => `/students/${id}/disable/`,
    ...
    multiClassRoster: '/students/multi-class/roster/',
    multiClassSave: '/students/multi-class/',
  },
  staff: {
    list: '/staff/',
    ...
    leaveRequestApply: '/staff/leave-requests/apply/',
    leaveRequestMine: '/staff/leave-requests/mine/',
    ...
    ratingDetail: (id: number) => `/staff/ratings/${id}/`,
    ratingApprove: (id: number) => `/staff/ratings/${id}/approve/`,
    ratingDecline: (id: number) => `/staff/ratings/${id}/decline/`,
  ...
  behaviour: {
    ...
    assignments: '/students/behaviour/assignments/',
    assignmentDetail: (id: number) => `/students/behaviour/assignments/${id}/`,
    settings: '/students/behaviour/settings/',
  },
  reportsApi: {
    userLogs: '/reports/user-logs/',
  ...
  fees: {
    ...
    studentAssignRoster: '/fees/student-assignments/roster/',
    studentAssignSave: '/fees/student-assignments/',
    carryForwardPreview: '/fees/carry-forward/preview/',
    ...
    positiveAdjustments: '/fees/positive-adjustments/',
    positiveAdjustmentsApply: '/fees/positive-adjustments/apply/',
    schemes: '/fees/schemes/',
    schemeDetail: (id: number) => `/fees/schemes/${id}/`,
    schemeConfig: (id: number) => `/fees/schemes/${id}/config/`,
    schemeApplications: '/fees/scheme-applications/',
    schemeApplicationApprove: (id: number) => `/fees/scheme-applications/${id}/approve/`,
    schemeApplicationReject: (id: number) => `/fees/scheme-applications/${id}/reject/`,
  },
  attendance: {
    ...
    hostelRoster: '/attendance/hostel/roster/',
    hostelMark: '/attendance/hostel/mark/',
    subjectPeriods: '/attendance/subject/periods/',
    subjectRoster: '/attendance/subject/roster/',
    subjectMark: '/attendance/subject/mark/',
  ...
  examinations: {
    ...
    cbseExamDetail: (id: number) => `/examinations/cbse-exams/${id}/`,
    cbseExamTimetable: (id: number) => `/examinations/cbse-exams/${id}/timetable/`,
    cbseMarksRoster: '/examinations/cbse-marks/roster/',
    cbseMarks: '/examinations/cbse-marks/',
    cbseMarksheet: '/examinations/cbse-marksheet/',
    admitCards: '/examinations/admit-cards/',
  ...
  transport: {
    ...
    studentFeesRoster: '/transport/student-fees/roster/',
    studentFeesAssign: '/transport/student-fees/assign/',
  },
  frontOffice: {
    ...
    visitorPurposes: '/front-office/visitor-purposes/',
    visitorPurposeDetail: (id: number) => `/front-office/visitor-purposes/${id}/`,
    phoneCalls: '/front-office/phone-calls/',
    phoneCallDetail: (id: number) => `/front-office/phone-calls/${id}/`,
  ...
  alumni: {
    ...
    studentDetail: (id: number) => `/alumni/students/${id}/`,
    events: '/alumni/events/',
    eventDetail: (id: number) => `/alumni/events/${id}/`,
    report: '/alumni/report/',
  },
  leads: {
    list: '/leads/',
    detail: (id: number) => `/leads/${id}/`,
    campaigns: '/leads/campaigns/',
    campaignDetail: (id: number) => `/leads/campaigns/${id}/`,
    followupStatuses: '/leads/followup-statuses/',
    followupStatusDetail: (id: number) => `/leads/followup-statuses/${id}/`,
    followups: '/leads/followups/',
    followupDetail: (id: number) => `/leads/followups/${id}/`,
    sources: '/leads/sources/',
    promoters: '/leads/promoters/',
    promoterDetail: (id: number) => `/leads/promoters/${id}/`,
    report: '/leads/report/',
  },
  cms: {
    events: '/cms/events/',
    eventDetail: (id: number) => `/cms/events/${id}/`,
    gallery: '/cms/gallery/',
    galleryDetail: (id: number) => `/cms/gallery/${id}/`,
    media: '/cms/media/',
    mediaDetail: (id: number) => `/cms/media/${id}/`,
    notices: '/cms/notices/',
    noticeDetail: (id: number) => `/cms/notices/${id}/`,
    pages: '/cms/pages/',
    pageDetail: (id: number) => `/cms/pages/${id}/`,
    menus: '/cms/menus/',
    menuDetail: (id: number) => `/cms/menus/${id}/`,
    menuItems: (id: number) => `/cms/menus/${id}/items/`,
    menuItemDetail: (id: number, itemId: number) => `/cms/menus/${id}/items/${itemId}/`,
    banners: '/cms/banners/',
    bannerDetail: (id: number) => `/cms/banners/${id}/`,
