export const API_ENDPOINTS = {
  ...
  academics: {
    ...
    homeworkEvaluations: '/academics/homework-evaluations/',
    homeworkEvaluationDetail: (id: number) => `/academics/homework-evaluations/${id}/`,
  ...
  fees: {
    ...
    feeMasters: '/fees/fee-master/',
    feeMasterDetail: (id: number) => `/fees/fee-master/${id}/`,
  ...
  attendance: {
    ...
    subjectReport: '/attendance/subject/report/',
  },
  examinations: {
    ...
    marksheetTemplates: '/examinations/templates/marksheets/',
    marksheetTemplateDetail: (id: number) => `/examinations/templates/marksheets/${id}/`,
    admitCardTemplates: '/examinations/templates/admit-cards/',
    admitCardTemplateDetail: (id: number) => `/examinations/templates/admit-cards/${id}/`,
  },
  hostel: {
