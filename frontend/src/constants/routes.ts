...
export const ROUTES = {
  ...
  lms: {
    ...
    offlinePayment: '/lms/offline-payments',
    reports: '/lms/reports',
    settings: '/lms/settings',
  },
  multiBranch: {
    root: '/multibranch',
    overview: '/multibranch/overview',
    report: '/multibranch/report',
    setting: '/multibranch/setting',
  },
  gmeet: {
    root: '/gmeet',
    classes: '/gmeet/classes',
    meeting: '/gmeet/meeting',
    report: '/gmeet/report',
    setting: '/gmeet/setting',
  },
  zoom: {
    root: '/zoom',
    ...
    report: '/zoom/report',
    meetingReport: '/zoom/meeting-report',
