...
export const PERMISSION_TO_LEGACY: Partial<Record<Permission, NavPermissionKey[]>> = {
  ...
  'students.disable_reasons.view': ['disable_reason'],
  'students.disable_reasons.create': ['disable_reason'],
  'students.disable_reasons.edit': ['disable_reason'],
  'students.disable_reasons.delete': ['disable_reason'],
  'students.multi_class.view': ['multi_class_student'],
  'behaviour.create': ['behaviour_records_incident', 'behaviour_records_assign_incident'],
  'behaviour.edit': ['behaviour_records_incident'],
  'behaviour.delete': ['behaviour_records_incident', 'behaviour_records_assign_incident'],
  ...
  'timetable.view': ['class_timetable', 'timetable_report'],
  ...
  'attendance.approve_leave': ['approve_leave'],
  'attendance.subject': ['subject_attendance'],
  ...
  'front_office.enquiry.view': ['admission_enquiry'],
  'front_office.enquiry.create': ['admission_enquiry'],
  'front_office.enquiry.edit': ['admission_enquiry'],
  'front_office.enquiry.delete': ['admission_enquiry'],
  'front_office.visitors.view': ['visitor_book'],
  'front_office.visitors.create': ['visitor_book'],
  'front_office.visitors.edit': ['visitor_book'],
  'front_office.visitors.delete': ['visitor_book'],
  'front_office.phone_calls.view': ['phone_call_log'],
  ...
  'front_office.postal_dispatch.view': ['postal_dispatch'],
  'front_office.postal_dispatch.create': ['postal_dispatch'],
  'front_office.postal_dispatch.edit': ['postal_dispatch'],
  'front_office.postal_dispatch.delete': ['postal_dispatch'],
  'front_office.postal_receive.view': ['postal_receive'],
  'front_office.postal_receive.create': ['postal_receive'],
  'front_office.postal_receive.edit': ['postal_receive'],
  'front_office.postal_receive.delete': ['postal_receive'],
  'front_office.complaints.view': ['complaint'],
  'front_office.complaints.create': ['complaint'],
  'front_office.complaints.edit': ['complaint'],
  'front_office.complaints.delete': ['complaint'],
  ...
  'manage_lesson_plan.view': ['manage_lesson_plan'],
  'manage_lesson_plan.create': ['manage_lesson_plan'],
  'manage_lesson_plan.edit': ['manage_lesson_plan'],
  'manage_lesson_plan.delete': ['manage_lesson_plan'],
  'copy_old_lesson.view': ['copy_old_lesson'],
  'copy_old_lesson.create': ['copy_old_lesson'],
  'front_office.setup_font_office.view': ['setup_font_office'],
  'front_office.setup_font_office.create': ['setup_font_office'],
  'front_office.setup_font_office.edit': ['setup_font_office'],
  'front_office.setup_font_office.delete': ['setup_font_office'],
  ...
  'reports.inventory.view': ['stock_report', 'add_item_report', 'issue_item_report'],
  'reports.homework.view': ['homework', 'daily_assignment'],
  'leads.create': ['all_leads'],
  'leads.edit': ['all_leads'],
  'leads.delete': ['all_leads'],
  'leads.campaigns.create': ['lead_manager'],
  'leads.campaigns.edit': ['lead_manager'],
  'leads.campaigns.delete': ['lead_manager'],
  'leads.sources.edit': ['lead_manager'],
  'leads.promoters.create': ['lead_manager'],
  'leads.promoters.delete': ['lead_manager'],
  'leads.followup_status.create': ['leads_follow_up'],
  'leads.followup_status.edit': ['leads_follow_up'],
  'leads.followup_status.delete': ['leads_follow_up'],
  'leads.followups.create': ['leads_follow_up'],
  'leads.followups.edit': ['leads_follow_up'],
  'leads.followups.delete': ['leads_follow_up'],
  'leads.reports.view': ['lead_manager'],
  'cms.event.create': ['event'],
  'cms.event.edit': ['event'],
  'cms.event.delete': ['event'],
  'cms.gallery.create': ['gallery'],
  'cms.gallery.edit': ['gallery'],
  'cms.gallery.delete': ['gallery'],
  'cms.notice.create': ['notice'],
  'cms.notice.edit': ['notice'],
  'cms.notice.delete': ['notice'],
  'cms.media.create': ['media_manager'],
  'cms.media.edit': ['media_manager'],
  'cms.media.delete': ['media_manager'],
  'cms.pages.create': ['pages'],
  'cms.pages.edit': ['pages'],
  'cms.pages.delete': ['pages'],
  'cms.menus.create': ['menus'],
  'cms.menus.edit': ['menus'],
  'cms.menus.delete': ['menus'],
  'cms.banners.create': ['banner_images'],
  'cms.banners.edit': ['banner_images'],
  'cms.banners.delete': ['banner_images'],
  'cms.settings.edit': ['front_cms_setting'],
  ...
  'downloadcenter.share.create': ['content_share_list'],
  'downloadcenter.share.delete': ['content_share_list'],
