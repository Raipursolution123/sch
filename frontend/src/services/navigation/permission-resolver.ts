...
export const PERMISSION_TO_LEGACY: Partial<Record<Permission, NavPermissionKey[]>> = {
  ...
  'staff.edit': ['staff'],
  'staff.delete': ['staff'],
  'settings.manage': ['general_setting', 'session_setting', 'language', 'currency', 'roles', 'user_status'],
  'academics.manage': ['class', 'section', 'subject', 'subject_group', 'class_timetable', 'assign_class_teacher', 'promote_student'],
  'fees.manage': ['collect_fees', 'fees_master', 'feetype', 'fees_group', 'fees_discount', 'fees_forward', 'search_due_fees', 'search_fees_payment', 'offline_bank_payments'],
