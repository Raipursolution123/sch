...
class TemplateMarksheets(models.Model):
    ...
    is_division = models.IntegerField(default=1, blank=True, null=True)
    is_rank = models.IntegerField(default=0, blank=True, null=True)
    is_customfield = models.IntegerField(default=0, blank=True, null=True)
    ...
    is_teacher_remark = models.IntegerField(default=1, blank=True, null=True)
