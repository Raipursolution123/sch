...
class PrintHeaderFooterListView(APIView):
    ...
    def get(self, request):
        ...
        return APIResponse.success(
            data=serializer.data, message="Print templates retrieved successfully"
        )
...
class PrintHeaderFooterDetailView(APIView):
    ...
    def get(self, request, pk):
        ...
        return APIResponse.success(
            data=serializer.data, message="Print template retrieved successfully"
        )
    ...
    def put(self, request, pk):
        ...
        serializer = PrintHeaderfooterSerializer(
            config, data=request.data, partial=True
        )
        if serializer.is_valid():
            serializer.save()
            return APIResponse.success(
                data=serializer.data, message="Print template updated successfully"
            )
        return APIResponse.error(
            message="Validation Error",
            details=serializer.errors,
