...
class RoutePickupPointSerializer(serializers.Serializer):
    ...
    destination_distance = serializers.FloatField(
        required=False, allow_null=True, default=0.0
    )
    pickup_time = serializers.TimeField(required=False, allow_null=True)
    order_number = serializers.FloatField(required=False, default=0.0)
...
class RoutePickupPointUpdateSerializer(serializers.Serializer):
    ...
    pickup_time = serializers.TimeField(required=False, allow_null=True)
    order_number = serializers.FloatField(required=False, allow_null=True)
