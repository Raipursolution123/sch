...
urlpatterns = [
    ...
    path(
        "visitors/", VisitorsBookListCreateView.as_view(), name="visitors-list-create"
    ),
    path(
        "visitors/<int:pk>/", VisitorsBookDetailView.as_view(), name="visitors-detail"
    ),
    path(
        "visitor-purposes/",
    ...
    path(
        "complaints/", ComplaintListCreateView.as_view(), name="complaints-list-create"
    ),
    path(
        "complaints/<int:pk>/", ComplaintDetailView.as_view(), name="complaints-detail"
    ),
    path(
        "complaint-types/",
        ComplaintTypeListCreateView.as_view(),
        name="complaint-types-list-create",
    ),
    path(
        "complaint-types/<int:pk>/",
        ComplaintTypeDetailView.as_view(),
        name="complaint-types-detail",
    ),
